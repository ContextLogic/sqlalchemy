...
class FromClause(Selectable):
    ...
    # PATCH(chutong): Added this method to support full outer join.
    def fullouterjoin(self, right, onclause=None):
        """return an outer join of this :class:`.FromClause` against another
        :class:`.FromClause`."""

        return Join(self, right, onclause, True, True)
...
class Join(FromClause):
    ...
    def __init__(self, left, right, onclause=None, isouter=False, isfullouter=False):
